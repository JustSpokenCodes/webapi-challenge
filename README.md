...
- {* it is written in JavaScript and used within Node.js
   * we can create and use our own localhost http and route it to different urls that we create as well. }

- [ ] Describe Middleware?
- { a fuction that allows the parts of the app to communicate and save data to allow to other parts of the app. It is a 'middleman' that tells the app whether or not this data will be stopped, changed or continue through the chain.}

- [ ] Describe a Resource?
- { a place in which the api is going to ie. id is a resource.}

- [ ] What can the API return to help clients know if a request was successful?
- { it can return a status code in the 200s }
